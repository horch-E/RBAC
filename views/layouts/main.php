...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" >
  <div class="container-fluid">
    ...
    <p class="navbar-text navbar-right">Hi,XXXX&nbsp&nbsp&nbsp&nbsp&nbsp</p>
    </div>
    </div>
</nav>
...
<div class="container-fluid">
  <div class="col-sm-2 col-md-2 col-lg-2 sidebar">
   <ul class="nav nav-sidebar">
    ...
    <div class="col-sm-10 col-sm-offset-2 col-md-10 col-dm-offset-2 col-lg-10 col-lg-offset-2">
    <?=$content;?>
      <hr/>
      <footer>
          <p class="pull-left">@Jarvis</p>
